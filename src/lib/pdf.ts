...
const generateDocuments = async (
  ...
  try {
    ...
    console.log(
      `User has ${remainingTokens} tokens left. According to the tokenizer, the user has used ${
...
export async function processPdf(
  ...
  try {
    ...
    try {
      ...
      console.log(
        `Elapsed time: to generate Embedding from Documents ${elapsedTime2} ms`,
      )
      ...
      console.log(
        `New token count: ${newTokenCountTotal}. According to the ChatGPT API, the user has used ${embeddingsTokenCount} tokens.`,
      )
      ...
      console.log(
        `Elapsed time: to createdocument in db , update token count in db and update redis, ${elapsedTime3} ms`,
      )
