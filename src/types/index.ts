...
export type UserInfoCache = Pick<
  SelectUser,
  'tokens' | 'image_generations_remaining'
>
...
export type ConversionModelAllButOpenJourney = Exclude<
  ConversionModel,
  ConversionModel.OPENJOURNEY
>
...
export interface TelegramBotMethods {
  isPolling(): boolean
